<x-app-layout>
    <div class="px-4 py-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <x-page-hero>
            <h1 id="page-title" class="text-4xl font-bold uppercase text-slate-800 dark:text-slate-300 sm:text-6xl font-lemonmilk">About Me</h1>
        </x-page-hero>
            ...
            <div class="flex flex-col p-4 lg:p-6">
                <div x-data="{ show: false }" x-init="setTimeout(function(){ show = true; }, 500)"
                    ...
                    <div class="flex flex-col w-full mb-4 space-y-2 lg:w-1/3 lg:mb-0">
                        <h1 class="mb-4 text-3xl font-bold lg:text-5xl font-protogrotesk text-slate-700 dark:text-slate-400">
                            {{ config('auth.admin.name') }}
                        </h1>
                        <span class="font-sans text-2xl font-semibold text-slate-800 dark:text-slate-300">
                            Years in web development:
                            <span class="text-xl text-slate-700 dark:text-slate-400">
                                16
                            </span>
                        </span>
                        <span class="font-sans text-2xl font-semibold text-slate-800 dark:text-slate-300">
                ...
                <p
                    class="mt-8 font-sans text-xl font-semibold leading-relaxed text-slate-700 dark:text-slate-400 first-letter:font-solo first-letter:text-2xl first-letter:italic">
