...
<section class="col-span-6 p-4 mb-2 overflow-hidden font-sans rounded-lg shadow-md group-link-underline xs:p-8 lg:p-8 lg:grid lg:grid-cols-3 lg:gap-4 bg-skin-fill-mantle">
    <!-- Post Image -->
