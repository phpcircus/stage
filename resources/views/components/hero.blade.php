<header id="up" class="relative h-56 mx-auto bg-fixed bg-center bg-no-repeat bg-cover md:px-12 xl:px-0 md:h-96">
    <!-- Overlay Background + Center Control -->
    <div class="flex justify-start h-48 md:h-80">
        <div>
            <div class="mx-2 text-left transform -rotate-3 font-badhandwriting">
                <h1 class="text-4xl font-semibold text-red-500 xs:text-7xl md:text-8xl">
                    <span class="text-gray-800">I'm</span>
                    Clay
                </h1>
                <h2 class="text-4xl font-semibold leading-tight text-red-500 xs:text-6xl md:text-7xl">
