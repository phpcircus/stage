<div class="group bg-yellow-500 dark:bg-indigo-900 fixed top-[90px] right-[-30px] w-16 h-12 rounded-md rounded-r-none shadow-extreme dark:shadow-none" x-on:click="$store.stage.toggleTheme()">
