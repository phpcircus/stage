<div class="group bg-yellow-500/75 dark:bg-indigo-900/80 fixed top-[90px] z-40 right-[-10rem] w-48 h-12 rounded-md rounded-r-none shadow-extreme dark:shadow-none lg:hover:right-0 transition-all duration-300"
