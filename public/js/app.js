...
/***/ "./resources/js/alpinejs/intersect/index.js":
/*!**************************************************!*\
  !*** ./resources/js/alpinejs/intersect/index.js ***!
  \**************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ function __WEBPACK_DEFAULT_EXPORT__(Alpine) {
  Alpine.directive('intersect', function (el, _ref, _ref2) {
...
window.Element.prototype._x_intersectEnter = function (callback, modifiers) {
  ...
  this._x_intersect(function (entry, observer) {
    if (pauseReactions) return;
    pauseReactions = true;

    if (entry.intersectionRatio > 0) {
      callback();
      modifiers.includes('once') && observer.unobserve(_this);
    }
...
window.Element.prototype._x_intersectLeave = function (callback, modifiers) {
  ...
  this._x_intersect(function (entry, observer) {
    ...
    if (!entry.intersectionRatio > 0) {
      callback();
      modifiers.includes('once') && observer.unobserve(_this2);
    }
...
window.Element.prototype._x_intersect = function (callback) {
  var observer = new IntersectionObserver(function (entries) {
    entries.forEach(function (entry) {
      return callback(entry, observer);
    });
  }, {// threshold: 1,
  });
...
/***/ "./resources/js/alpinejs/persist/index.js":
/*!************************************************!*\
  !*** ./resources/js/alpinejs/persist/index.js ***!
  \************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony default export */ function __WEBPACK_DEFAULT_EXPORT__(Alpine) {
  Alpine.magic('persist', function (el, _ref) {
    var interceptor = _ref.interceptor;
    return interceptor(function (initialValue, getter, setter, path, key) {
      var initial = localStorage.getItem(path) ? localStorage.getItem(path) : initialValue;
      setter(initialValue);
...
/* harmony import */ var _alpinejs_intersect__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./alpinejs/intersect */ "./resources/js/alpinejs/intersect/index.js");
/* harmony import */ var _alpinejs_persist__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./alpinejs/persist */ "./resources/js/alpinejs/persist/index.js");
/* harmony import */ var _ryangjchandler_fern__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @ryangjchandler/fern */ "./node_modules/@ryangjchandler/fern/dist/module.esm.js");
...
alpinejs__WEBPACK_IMPORTED_MODULE_0__.default.plugin(_ryangjchandler_fern__WEBPACK_IMPORTED_MODULE_3__.default);
...
alpinejs__WEBPACK_IMPORTED_MODULE_0__.default.persistedStore('stage', {
  mobileMenuOpen: false,
  darkMode: true,
  theme: 'dark',
  seen: null,
  newest: null,
  setSeenToNewest: function setSeenToNewest() {
    this.seen = this.newest;
  },
  hasntSeenNewest: function hasntSeenNewest() {
    return this.seen != this.newest;
  },
  getDarkMode: function getDarkMode() {
